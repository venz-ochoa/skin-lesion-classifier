...
# Kaggle Troubleshooting (if theres errors)
...
# Instructions
1.  To download dependencies and datasets, run download_data.py. The user is given the option to download only dependencies, only datasets, or both. HAM10000 uses Kaggle API to download datasets and will take approx. 5-10 minutes of downloading time.
